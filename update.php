...
$sql = "INSERT INTO t2(id,name,book_name,order_date)VALUES('$id','$name','$book_name','$order_date')";
$sql1="UPDATE book SET book_quantity = book_quantity-1 WHERE book_name = '$book_name'";
